...
class VPravdaParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//article[contains(@id,"post")]');
        ...
        $this->removeDomNodes($contentCrawler, '//figure[contains(@class,"is-type-wp-embed")]');
