...
class RassvetNewsRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        | //p[descendant::text()[contains(., "Источник")]]
        | //p[descendant::text()[contains(., "Так же по этой теме:")]]/following-sibling::*
        | //p[descendant::text()[contains(., "Так же по этой теме:")]]');
