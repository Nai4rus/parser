...
class PermvRuParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filter('.newsdetail_block .js-mediator-article');

        $description = $this->getDescriptionFromContentText($contentCrawler);

        $image = null;
        $mainImageCrawler = $newsPageCrawler->filterXPath('//div[contains(@class,"newsdetail_block__image_img")]/img[1]');
        if ($this->crawlerHasNodes($mainImageCrawler)) {
            ...
            $this->removeDomNodes($contentCrawler, '//div[contains(@class,"newsdetail_block__image_img")]');
        }
