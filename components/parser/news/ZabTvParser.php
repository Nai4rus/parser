...
class ZabTvParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $contentCrawler = $newsPageCrawler->filterXPath('//*[@id="zab-article"]//article//*[contains(concat(" ",normalize-space(@class)," ")," row-max ")]/*[contains(concat(" ",normalize-space(@class)," ")," text ")] | //*[@id="zab-article"]//article//figure//*[contains(concat(" ",normalize-space(@class)," ")," resp ")]');
