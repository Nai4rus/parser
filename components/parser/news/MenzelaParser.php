...
class MenzelaParser implements ParserInterface
{
    public const USER_ID = 2;
    public const FEED_ID = 2;
    private const SITE_URL = 'http://menzela.ru';
    ...
    private function parseNewsPage(PreviewNewsDTO $previewNewsItem): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="page-main"]');
        ...
        $description = $newsPostCrawler->filterXPath('//p[contains(@class,"page-main__lead")]')->text();

        $contentXPath = '//div[@class="page-main__text"]';
        $contentCrawler = $newsPostCrawler->filterXPath($contentXPath);

        $this->removeDomNodes($contentCrawler, '//div[contains(text(),"Реклама")]/ancestor::*[parent::div[contains(@class,"page-main__text")]]');
